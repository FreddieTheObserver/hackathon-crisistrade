...
export const ProfileReputationPanel = ({ isVerified, reputationPoints }: ProfileReputationPanelProps) => {
  return (
    <article className="flex min-h-44 flex-col items-center justify-center rounded-lg bg-emerald-50 p-6 text-center shadow-sm">
      <h2 className="text-lg font-bold text-emerald-800">Reputation Points</h2>
      ...
      <div className="mt-5 flex items-center justify-center gap-5">
        ...
        <p className="text-3xl font-bold tracking-normal text-emerald-800">{reputationPoints.toLocaleString()}</p>
      </div>
